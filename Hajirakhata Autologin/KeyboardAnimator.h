...
//
// to check the update check the following repositories in the github
...
#define DEFAULT_SPACING_BETWEEN_TEXTFIELD_AND_KEYBOARD  30.0f //15.0f

#define DEFAULT_SPACING_WHILE_SQUEEZING                 5.0f
